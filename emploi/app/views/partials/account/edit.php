...
<section class="page" id="<?php echo $page_element_id; ?>" data-page-type="edit"  data-display-type="" data-page-url="<?php print_link($current_page); ?>">
    ...
    <div  class="bg-light p-3 mb-3">
        <div class="container">
            <div class="row ">
                <div class="col ">
                    <h4 class="record-title">Mon compte</h4>
                </div>
            </div>
        </div>
    </div>
                            ...
                            <div>
                                <div class="form-group ">
                                    <div class="row">
                                        ...
                                        <div class="col-sm-8">
                                            <div class="">
                                                <input id="ctrl-identification"  value="<?php  echo $data['identification']; ?>" type="text" placeholder="Entrer Identification"  required="" name="identification"  data-url="api/json/account_identification_value_exist/" data-loading-msg="Vérifier les disponibilités ..." data-available-msg="Disponible" data-unavailable-msg="Indisponible" class="form-control  ctrl-check-duplicate" />
                                    ...
                                    <div class="form-group ">
                                        <div class="row">
                                            ...
                                            <div class="col-sm-8">
                                                <div class="">
                                                    <input id="ctrl-login"  value="<?php  echo $data['login']; ?>" type="text" placeholder="Entrer Login"  required="" name="login"  class="form-control " />
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="form-group ">
                                            ...
                                            <div class="form-group ">
                                                <div class="row">
                                                    ...
                                                    <div class="col-sm-8">
                                                        <div class="">
                                                            <input id="ctrl-cellulaire"  value="<?php  echo $data['cellulaire']; ?>" type="text" placeholder="Entrer Cellulaire"  required="" name="cellulaire"  class="form-control " />
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
