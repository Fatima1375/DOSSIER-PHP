                ...
                <div class="row ">
                    <div class="col-md-2 comp-grid">
                        <form method="get" action="<?php print_link($current_page) ?>" class="form filter-form">
                            <div class="card mb-3">
                                ...
                                <div class="p-2">
                                    <select   name="cv_specialite" class="form-control custom ">
                                        <option value="">Sélectionnez une valeur</option>
                                        <?php 
                                        $cv_specialite_options = $comp_model -> cv_cvspecialite_option_list();
                                        if(!empty($cv_specialite_options)){
                                        foreach($cv_specialite_options as $option){
                                        $value = (!empty($option['value']) ? $option['value'] : null);
                                        $label = (!empty($option['label']) ? $option['label'] : $value);
                                        $selected = $this->set_field_selected('cv_specialite',$value);
                                        ?>
                    ...
                    <div class="col-md-10 comp-grid">
                        ...
                        <div class="filter-tags mb-2">
                            <?php
                            if(!empty(get_value('cv_specialite'))){
                            ?>
                            <div class="filter-chip card bg-light">
                                <b>Cv Specialite :</b> 
                                <?php 
                                if(get_value('cv_specialitelabel')){
                                echo get_value('cv_specialitelabel');
                                }
                                else{
                                echo get_value('cv_specialite');
                                }
                                $remove_link = unset_get_value('cv_specialite', $this->route->page_url);
                                ?>
