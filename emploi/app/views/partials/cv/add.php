                            ...
                            <div>
                                <div class="form-group ">
                                    <div class="row">
                                        ...
                                        <div class="col-sm-8">
                                            <div class="">
                                                <input id="ctrl-age"  value="<?php  echo $this->set_field_value('age',""); ?>" type="number" placeholder="Entrer Age" step="1"  required="" name="age"  class="form-control " />
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="form-group ">
                                        <div class="row">
                                            ...
                                            <div class="col-sm-8">
                                                <div class="">
                                                    <textarea placeholder="Entrer Adresse" id="ctrl-adresse"  required="" rows="5" name="adresse" class="htmleditor form-control"><?php  echo $this->set_field_value('adresse',""); ?></textarea>
                                            ...
                                            <div class="col-sm-8">
                                                <div class="">
                                                    <select required=""  id="ctrl-niveau_etudes" name="niveau_etudes"  placeholder="Sélectionnez une valeur"    class="custom-select" >
                                                        ...
                                                        $value = (!empty($option['value']) ? $option['value'] : null);
                                                        $label = (!empty($option['label']) ? $option['label'] : $value);
                                                        $selected = $this->set_field_selected('niveau_etudes',$value, "");
                                                        ?>
                                                        <option <?php echo $selected; ?> value="<?php echo $value; ?>">
                                                            <?php echo $label; ?>
                                                        </option>
                                    ...
                                    <div class="form-group ">
                                        <div class="row">
                                            ...
                                            <div class="col-sm-8">
                                                <div class="">
                                                    <input id="ctrl-exprience_professionnelle"  value="<?php  echo $this->set_field_value('exprience_professionnelle',""); ?>" type="text" placeholder="Entrer Exprience Professionnelle"  required="" name="exprience_professionnelle"  class="form-control " />
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
