                            ...
                            <div>
                                <div class="form-group ">
                                    <div class="row">
                                        ...
                                        <div class="col-sm-8">
                                            <div class="">
                                                <input id="ctrl-role_name"  value="<?php  echo $this->set_field_value('role_name',""); ?>" type="text" placeholder="Entrer Role Name"  required="" name="role_name"  class="form-control " />
                                                </div>
                                            </div>
                                        </div>
                                    </div>
