                    ...
                    <li class="nav-item dropdown">
                        <a class="nav-link dropdown-toggle" href="#" data-toggle="dropdown">
                            ...
                            <ul class="dropdown-menu">
                                <a class="dropdown-item" href="<?php print_link('account') ?>"><i class="fa fa-user"></i> Mon compte</a>
                                <a class="dropdown-item" href="<?php print_link('index/logout?csrf_token=' . Csrf::$token) ?>"><i class="fa fa-sign-out"></i> Connectez - Out</a>
                            </ul>
                        </li>
                    </ul>
                </div>
            ...
            <ul class="nav navbar-nav w-100 flex-column align-self-start">
                <li class="menu-profile text-center nav-item">
                    <a class="avatar" href="<?php print_link('account') ?>">
                        ...
                        if(!empty(USER_PHOTO)){
                        ?>
                        <img class="img-fluid rounded-circle" src="<?php print_link(set_img_src(USER_PHOTO,90,90)); ?>" />
                            <?php
                            }
                            else{
                            ?>
                        ...
                        <h5 class="user-name">Salut 
                            <?php echo ucwords(USER_NAME); ?></br>
                            <small ><?php echo ACL::$user_role; ?> </small>
                        </h5>
